...
public abstract class ContentSource<T : ContentItem> {

    public abstract val items: List<T>

    public abstract val displayName: String

    public fun isSameAs(other: ContentSource<*>): Boolean {
...
public data class FilteredContentSource<T : ContentItem>(
...
public object AndroidReleases : ContentSource<ContentItem.AndroidRelease>() {

    override val items: List<ContentItem.AndroidRelease> =
        listOf(
    ...
    override val displayName: String = "Android releases"
}
