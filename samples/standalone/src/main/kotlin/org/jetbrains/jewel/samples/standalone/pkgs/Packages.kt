...
import org.jetbrains.jewel.LocalTypography
...
import org.jetbrains.jewel.themes.intui.standalone.control.Chip
...
sealed class Target(
    ...
    fun composable() {
        ...
        Chip(
            ...
            Text(modifier = Modifier.padding(horizontal = 8.dp), maxLines = 1, text = shortName, color = fontColor)
        }
    }
            ...
            stickyHeader("header") {
                Row(
                    ...
                    Text(
                        ...
                        style = LocalTypography.current.default.copy(fontWeight = FontWeight.Bold)
                    )
                }
            }
            ...
            if (availableFilters.isNotEmpty()) {
                availableFilters.forEach { filter ->
                    Row(Modifier.padding(start = 4.dp)) {
                        ...
                        Text(modifier = Modifier.padding(start = 4.dp), text = filter.key)
                    }
                }
            }
        }
