 ...
 *
 * An area corresponding to the result of [BadgeShape.createHoleOutline] is cleared out first, to
 * allow for visual separation with the badge,and then the [BadgeShape.createOutline] is filled with
 * the [color].
 */
public class BadgePainter(
    ...
    /**
     * Optional [Paint] used to draw contents into an offscreen layer to apply alpha or
