...
/**
 * Creates a PainterHint that replaces all colors in the [paletteMap] with
 * their corresponding new value. It is used in IJ up to 23.3 to support
 * patching the SVG colors for checkboxes and radio buttons.
 */
