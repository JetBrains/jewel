...
public class MenuManager(
    ...
    /**
     * Called when the hovered state of the menu changes. This is used to abort parent menu closing in
     * unforced mode when submenu closed by click parent menu's item.
     *
