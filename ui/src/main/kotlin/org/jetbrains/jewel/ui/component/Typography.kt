 ...
 * [the default `TextStyle`][JewelTheme.defaultTextStyle]. These match the functionality provided by
 * `JBFont` in the IntelliJ Platform.
 */
public object Typography {
    ...
    public fun h0TextStyle(): TextStyle =
        JewelTheme.defaultTextStyle.copy(
            fontSize = labelTextSize() + 12.sp, fontWeight = FontWeight.Bold)

    /** The text style to use for h1 titles. Derived from [JewelTheme.defaultTextStyle]. */
    @Composable
    public fun h1TextStyle(): TextStyle =
        JewelTheme.defaultTextStyle.copy(
            fontSize = labelTextSize() + 9.sp, fontWeight = FontWeight.Bold)
    ...
    public fun h4TextStyle(): TextStyle =
        JewelTheme.defaultTextStyle.copy(
            fontSize = labelTextSize() + 1.sp, fontWeight = FontWeight.Bold)
    ...
    /**
     * The text style used for code consoles. Usually is a monospaced font. Can be the same as
     * [editorTextStyle].
     */
...
public operator fun TextUnit.plus(other: TextUnit): TextUnit =
    when {
        ...
        isUnspecified && other.isUnspecified ->
            TextUnit(value + other.value, TextUnitType.Unspecified)
