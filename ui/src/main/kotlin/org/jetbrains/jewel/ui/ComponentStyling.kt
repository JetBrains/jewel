...
private class StaticComponentStyling(private val values: Array<out ProvidedValue<*>>) :
    ComponentStyling {
...
private class LazyComponentStyling(val provider: @Composable () -> Array<out ProvidedValue<*>>) :
    ComponentStyling {
