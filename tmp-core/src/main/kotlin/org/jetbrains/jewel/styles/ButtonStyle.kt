...
typealias ButtonStyle = ControlStyle<ButtonState, ButtonAppearance>

val LocalButtonStyle = compositionLocalOf<ButtonStyle> { localNotProvided() }
val LocalPrimaryButtonStyle = compositionLocalOf<ButtonStyle> { localNotProvided() }
val LocalOutLinedButtonStyle = compositionLocalOf<ButtonStyle> { localNotProvided() }

val Styles.button: ButtonStyle
    @Composable @ReadOnlyComposable
    get() = LocalButtonStyle.current

val Styles.defaultButton: ButtonStyle
    @Composable @ReadOnlyComposable
...
fun ButtonStyle(
    ...
    shape,
    minSize
) { focusHaloStroke, defaultAppearance ->
...
private fun ControlStyle.ControlStyleBuilder<ButtonState, ButtonAppearance>.populateStates(
