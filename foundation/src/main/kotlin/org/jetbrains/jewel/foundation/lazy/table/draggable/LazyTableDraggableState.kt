...
public fun rememberLazyTableRowDraggingState(
    ...
    remember(tableState, onMove) {
        LazyTableRowDraggingState(tableState, itemCanMove, onMove)
    }
...
public fun rememberLazyTableColumnDraggingState(
    ...
    remember(tableState, onMove) {
        LazyTableColumnDraggingState(tableState, itemCanMove, onMove)
    }
