...
internal class LazyTableHorizontalScrollbarAdapter(
    ...
    override fun firstVisibleLine(): VisibleLine? {
        val item = scrollState.layoutInfo.pinnedRowsInfo.firstOrNull()
    ...
    override fun totalLineCount() = if (scrollState.layoutInfo.rows > 0) scrollState.layoutInfo.columns else 0
    ...
    override fun averageVisibleLineSize(): Double {
        val first = scrollState.layoutInfo.pinnedRowsInfo.firstOrNull()
            ?: scrollState.layoutInfo.floatingItemsInfo.firstOrNull()
            ?: return 0.0
        val last = scrollState.layoutInfo.pinnedRowsInfo.lastOrNull()
...
internal class LazyTableVerticalScrollbarAdapter(
    ...
    override fun firstVisibleLine(): VisibleLine? {
        val item = scrollState.layoutInfo.pinnedColumnsInfo.firstOrNull()
            ?: scrollState.layoutInfo.floatingItemsInfo.firstOrNull()
            ?: return null
        return VisibleLine(
            index = item.row,
    ...
    override fun totalLineCount() = if (scrollState.layoutInfo.columns > 0) scrollState.layoutInfo.rows else 0
    ...
    override fun averageVisibleLineSize(): Double {
        val first = scrollState.layoutInfo.pinnedColumnsInfo.firstOrNull()
            ?: scrollState.layoutInfo.floatingItemsInfo.firstOrNull()
            ?: return 0.0
        val last = scrollState.layoutInfo.pinnedColumnsInfo.lastOrNull()
            ?: scrollState.layoutInfo.floatingItemsInfo.lastOrNull()
            ?: return 0.0
