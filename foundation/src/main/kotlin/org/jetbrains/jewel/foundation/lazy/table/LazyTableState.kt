...
public class LazyTableState(
    ...
    public val horizontalScrollableState: ScrollableState =
        ScrollableState {
    ...
    public val verticalScrollableState: ScrollableState =
        ScrollableState {
            -onVerticalScroll(-it)
        }
    ...
    public val tableInfo: LazyTableInfo get() = tableInfoState.value
    ...
    internal fun snapToColumnInternal(
        column: Int,
        scrollOffset: Int,
    ) {
    ...
    internal fun snapToRowInternal(
        row: Int,
        scrollOffset: Int,
    ) {
