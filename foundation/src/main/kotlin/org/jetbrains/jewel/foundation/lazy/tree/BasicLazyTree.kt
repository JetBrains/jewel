        ...
        itemsIndexed(
            ...
            val elementState =
                TreeElementState.of(
                    ...
                    selected = isSelected,
                    expanded =
                        (element as? Tree.Element.Node)?.let { it.id in treeState.openNodes }
                            ?: false,
                )
            ...
            val backgroundShape by derivedStateOf {
                ...
                val topCornerSize =
                    computerCornerSize(hasRoundedTopCorners, elementBackgroundCornerSize)
                val bottomCornerSize =
                    computerCornerSize(hasRoundedBottomCorners, elementBackgroundCornerSize)
                RoundedCornerShape(
