...
object DarkPalette {
     ...
     * General icons: Fill
     */
    val Purple1 = Color(0xFF2F2936)
    val Purple2 = Color(0xFF433358)
    val Purple3 = Color(0xFF583D7A)
    val Purple4 = Color(0xFF6C469C)
    val Purple5 = Color(0xFF8150BE)
    val Purple6 = Color(0xFF955AE0)
     ...
     * Outline icons
     */
    val Purple7 = Color(0xFFA571E6)
    val Purple8 = Color(0xFFB589EC)
    val Purple9 = Color(0xFFC4A0F3)
    val Purple10 = Color(0xFFD4B8F9)
    val Purple11 = Color(0xFFE4CEFF)

    /**
     * General icons: Fill
     */
    val Teal1 = Color(0xFF1D3838)
    val Teal2 = Color(0xFF1E4D4A)
    val Teal3 = Color(0xFF20635D)
    val Teal4 = Color(0xFF21786F)
    val Teal5 = Color(0xFF238E82)
     ...
     * Outline icons
     */
    val Teal6 = Color(0xFF24A394)
    val Teal7 = Color(0xFF42B1A4)
    val Teal8 = Color(0xFF60C0B5)
    val Teal9 = Color(0xFF7DCEC5)
    val Teal10 = Color(0xFF9BDDD6)
    val Teal11 = Color(0xFFB9EBE6)
}
