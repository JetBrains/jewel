...
/**
 * Create [PainterProvider][org.jetbrains.jewel.painter.PainterProvider] for decorated window module
 * resource.
 */
public fun decoratedWindowPainterProvider(path: String): ResourcePainterProvider =
    ResourcePainterProvider(
        path,
        DecoratedWindowStyle::class.java.classLoader,
        JewelTheme::class.java.classLoader,
    )
