...
public val ToolwindowGroup.`Debug@20x20`: IntellijIconData
    get() {
        if (`_debug@20x20` != null) {
            return `_debug@20x20`!!
        }
        `_debug@20x20` = IntellijIconData(imageVector = { `Debug@20x20Composable`(it) })
        return `_debug@20x20`!!
    }

private var `_debug@20x20`: IntellijIconData? = null

private fun `Debug@20x20Composable`(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "Debug@20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp, viewportWidth = 20.0f,
