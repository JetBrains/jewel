...
public val ActionsGroup.ShowwriteaccessDark: ImageVector
    get() {
        if (_showwriteaccessDark != null) {
            return _showwriteaccessDark!!
        }
        _showwriteaccessDark = Builder(name = "ShowwriteaccessDark", defaultWidth = 16.0.dp,
