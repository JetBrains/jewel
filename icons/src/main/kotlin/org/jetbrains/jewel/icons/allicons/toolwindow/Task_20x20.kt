...
public val ToolwindowGroup.Task_20x20: IntellijIconData
    get() {
        if (_task_20x20 != null) {
            return _task_20x20!!
        }
        _task_20x20 = IntellijIconData(name = "Task_20x20",size = DpSize(height = 20.0.dp, width =
                20.0.dp),imageVector = { Task_20x20Composable(it) })
        return _task_20x20!!
    }

private var _task_20x20: IntellijIconData? = null

private fun Task_20x20Composable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "Task_20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp, viewportWidth = 20.0f,
