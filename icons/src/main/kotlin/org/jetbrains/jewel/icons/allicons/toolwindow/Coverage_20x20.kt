...
public val ToolwindowGroup.Coverage_20x20: IntellijIconData
    get() {
        if (_coverage_20x20 != null) {
            return _coverage_20x20!!
        }
        _coverage_20x20 = IntellijIconData(name = "Coverage_20x20",size = DpSize(height = 20.0.dp,
                width = 20.0.dp),imageVector = { Coverage_20x20Composable(it) })
        return _coverage_20x20!!
    }

private var _coverage_20x20: IntellijIconData? = null

private fun Coverage_20x20Composable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "Coverage_20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp, viewportWidth = 20.0f,
