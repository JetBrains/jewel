...
public val ToolwindowGroup.ToolWindowVariableView_20x20: IntellijIconData
    get() {
        if (_toolWindowVariableView_20x20 != null) {
            return _toolWindowVariableView_20x20!!
        }
        _toolWindowVariableView_20x20 = IntellijIconData(name = "ToolWindowVariableView_20x20",size
                = DpSize(height = 20.0.dp, width = 20.0.dp),imageVector = {
                ToolWindowVariableView_20x20Composable(it) })
        return _toolWindowVariableView_20x20!!
    }

private var _toolWindowVariableView_20x20: IntellijIconData? = null

private fun ToolWindowVariableView_20x20Composable(colorScheme: IntelliJIconColors): ImageVector =
        Builder(name = "ToolWindowVariableView_20x20", defaultWidth = 20.0.dp, defaultHeight =
