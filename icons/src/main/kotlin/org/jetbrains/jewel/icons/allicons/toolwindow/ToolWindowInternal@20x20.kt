...
public val ToolwindowGroup.`ToolWindowInternal@20x20`: IntellijIconData
    get() {
        if (`_toolWindowInternal@20x20` != null) {
            return `_toolWindowInternal@20x20`!!
        }
        `_toolWindowInternal@20x20` = IntellijIconData(imageVector = {
                `ToolWindowInternal@20x20Composable`(it) })
        return `_toolWindowInternal@20x20`!!
    }

private var `_toolWindowInternal@20x20`: IntellijIconData? = null

private fun `ToolWindowInternal@20x20Composable`(colorScheme: IntelliJIconColors): ImageVector =
        Builder(name = "ToolWindowInternal@20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp,
