...
public val ToolwindowGroup.Hierarchy_20x20: IntellijIconData
    get() {
        if (_hierarchy_20x20 != null) {
            return _hierarchy_20x20!!
        }
        _hierarchy_20x20 = IntellijIconData(name = "Hierarchy_20x20",size = DpSize(height = 20.0.dp,
                width = 20.0.dp),imageVector = { Hierarchy_20x20Composable(it) })
        return _hierarchy_20x20!!
    }

private var _hierarchy_20x20: IntellijIconData? = null

private fun Hierarchy_20x20Composable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "Hierarchy_20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp, viewportWidth = 20.0f,
