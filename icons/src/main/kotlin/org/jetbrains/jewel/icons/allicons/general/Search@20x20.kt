...
public val GeneralGroup.`Search@20x20`: IntellijIconData
    get() {
        if (`_search@20x20` != null) {
            return `_search@20x20`!!
        }
        `_search@20x20` = IntellijIconData(imageVector = { `Search@20x20Composable`(it) })
        return `_search@20x20`!!
    }

private var `_search@20x20`: IntellijIconData? = null

private fun `Search@20x20Composable`(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "Search@20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp, viewportWidth = 20.0f,
