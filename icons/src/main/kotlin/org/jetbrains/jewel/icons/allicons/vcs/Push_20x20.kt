...
public val VcsGroup.Push_20x20: IntellijIconData
    get() {
        if (_push_20x20 != null) {
            return _push_20x20!!
        }
        _push_20x20 = IntellijIconData(name = "Push_20x20",size = DpSize(height = 20.0.dp, width =
                20.0.dp),imageVector = { Push_20x20Composable(it) })
        return _push_20x20!!
    }

private var _push_20x20: IntellijIconData? = null

private fun Push_20x20Composable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "Push_20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp, viewportWidth = 20.0f,
