...
public val ActionsGroup.NewFolder: IntellijIconData
    get() {
        if (_newFolder != null) {
            return _newFolder!!
        }
        _newFolder = IntellijIconData(name = "NewFolder",size = DpSize(height = 16.0.dp, width =
                16.0.dp),imageVector = { NewFolderComposable(it) })
        return _newFolder!!
    }

private var _newFolder: IntellijIconData? = null

private fun NewFolderComposable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "NewFolder", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp, viewportWidth = 16.0f,
