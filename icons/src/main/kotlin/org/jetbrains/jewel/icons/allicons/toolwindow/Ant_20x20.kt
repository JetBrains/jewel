...
public val ToolwindowGroup.Ant_20x20: IntellijIconData
    get() {
        if (_ant_20x20 != null) {
            return _ant_20x20!!
        }
        _ant_20x20 = IntellijIconData(name = "Ant_20x20",size = DpSize(height = 20.0.dp, width =
                20.0.dp),imageVector = { Ant_20x20Composable(it) })
        return _ant_20x20!!
    }

private var _ant_20x20: IntellijIconData? = null

private fun Ant_20x20Composable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "Ant_20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp, viewportWidth = 20.0f,
