...
public val ActionsGroup.ProjectdirectoryDark: ImageVector
    get() {
        if (_projectdirectoryDark != null) {
            return _projectdirectoryDark!!
        }
        _projectdirectoryDark = Builder(name = "ProjectdirectoryDark", defaultWidth = 16.0.dp,
