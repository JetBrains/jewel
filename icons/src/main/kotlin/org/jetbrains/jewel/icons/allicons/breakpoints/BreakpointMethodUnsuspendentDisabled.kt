...
public val BreakpointsGroup.BreakpointMethodUnsuspendentDisabled: IntellijIconData
    get() {
        if (_breakpointMethodUnsuspendentDisabled != null) {
            return _breakpointMethodUnsuspendentDisabled!!
        }
        _breakpointMethodUnsuspendentDisabled = IntellijIconData(name =
                "BreakpointMethodUnsuspendentDisabled",size = DpSize(height = 14.0.dp, width =
                14.0.dp),imageVector = { BreakpointMethodUnsuspendentDisabledComposable(it) })
        return _breakpointMethodUnsuspendentDisabled!!
    }

private var _breakpointMethodUnsuspendentDisabled: IntellijIconData? = null

private fun BreakpointMethodUnsuspendentDisabledComposable(colorScheme: IntelliJIconColors):
        ImageVector = Builder(name = "BreakpointMethodUnsuspendentDisabled", defaultWidth = 14.0.dp,
