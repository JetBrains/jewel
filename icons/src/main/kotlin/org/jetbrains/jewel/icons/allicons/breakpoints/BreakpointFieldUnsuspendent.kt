...
public val BreakpointsGroup.BreakpointFieldUnsuspendent: IntellijIconData
    get() {
        if (_breakpointFieldUnsuspendent != null) {
            return _breakpointFieldUnsuspendent!!
        }
        _breakpointFieldUnsuspendent = IntellijIconData(name = "BreakpointFieldUnsuspendent",size =
                DpSize(height = 14.0.dp, width = 14.0.dp),imageVector = {
                BreakpointFieldUnsuspendentComposable(it) })
        return _breakpointFieldUnsuspendent!!
    }

private var _breakpointFieldUnsuspendent: IntellijIconData? = null

private fun BreakpointFieldUnsuspendentComposable(colorScheme: IntelliJIconColors): ImageVector =
        Builder(name = "BreakpointFieldUnsuspendent", defaultWidth = 14.0.dp, defaultHeight =
