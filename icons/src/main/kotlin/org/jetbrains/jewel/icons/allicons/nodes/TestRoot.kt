...
public val NodesGroup.TestRoot: IntellijIconData
    get() {
        if (_testRoot != null) {
            return _testRoot!!
        }
        _testRoot = IntellijIconData(name = "TestRoot",size = DpSize(height = 16.0.dp, width =
                16.0.dp),imageVector = { TestRootComposable(it) })
        return _testRoot!!
    }

private var _testRoot: IntellijIconData? = null

private fun TestRootComposable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "TestRoot", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp, viewportWidth = 16.0f,
