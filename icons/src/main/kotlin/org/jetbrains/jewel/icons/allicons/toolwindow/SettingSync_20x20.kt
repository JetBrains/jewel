...
public val ToolwindowGroup.SettingSync_20x20: IntellijIconData
    get() {
        if (_settingSync_20x20 != null) {
            return _settingSync_20x20!!
        }
        _settingSync_20x20 = IntellijIconData(name = "SettingSync_20x20",size = DpSize(height =
                20.0.dp, width = 20.0.dp),imageVector = { SettingSync_20x20Composable(it) })
        return _settingSync_20x20!!
    }

private var _settingSync_20x20: IntellijIconData? = null

private fun SettingSync_20x20Composable(colorScheme: IntelliJIconColors): ImageVector = Builder(name
        = "SettingSync_20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp, viewportWidth =
