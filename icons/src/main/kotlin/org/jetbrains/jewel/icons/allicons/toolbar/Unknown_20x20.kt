...
public val ToolbarGroup.Unknown_20x20: IntellijIconData
    get() {
        if (_unknown_20x20 != null) {
            return _unknown_20x20!!
        }
        _unknown_20x20 = IntellijIconData(name = "Unknown_20x20",size = DpSize(height = 20.0.dp,
                width = 20.0.dp),imageVector = { Unknown_20x20Composable(it) })
        return _unknown_20x20!!
    }

private var _unknown_20x20: IntellijIconData? = null

private fun Unknown_20x20Composable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "Unknown_20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp, viewportWidth = 20.0f,
