...
public val WelcomeGroup.FromVCSTab: IntellijIconData
    get() {
        if (_fromVCSTab != null) {
            return _fromVCSTab!!
        }
        _fromVCSTab = IntellijIconData(name = "FromVCSTab",size = DpSize(height = 20.0.dp, width =
                20.0.dp),imageVector = { FromVCSTabComposable(it) })
        return _fromVCSTab!!
    }

private var _fromVCSTab: IntellijIconData? = null

private fun FromVCSTabComposable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "FromVCSTab", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp, viewportWidth = 20.0f,
