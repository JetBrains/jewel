...
public val ActionsGroup.MoveToButton: IntellijIconData
    get() {
        if (_moveToButton != null) {
            return _moveToButton!!
        }
        _moveToButton = IntellijIconData(name = "MoveToButton",size = DpSize(height = 16.0.dp, width
                = 16.0.dp),imageVector = { MoveToButtonComposable(it) })
        return _moveToButton!!
    }

private var _moveToButton: IntellijIconData? = null

private fun MoveToButtonComposable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "MoveToButton", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp, viewportWidth = 16.0f,
