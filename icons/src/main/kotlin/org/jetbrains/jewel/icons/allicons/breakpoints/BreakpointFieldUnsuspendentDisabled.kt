...
public val BreakpointsGroup.BreakpointFieldUnsuspendentDisabled: IntellijIconData
    get() {
        if (_breakpointFieldUnsuspendentDisabled != null) {
            return _breakpointFieldUnsuspendentDisabled!!
        }
        _breakpointFieldUnsuspendentDisabled = IntellijIconData(name =
                "BreakpointFieldUnsuspendentDisabled",size = DpSize(height = 14.0.dp, width =
                14.0.dp),imageVector = { BreakpointFieldUnsuspendentDisabledComposable(it) })
        return _breakpointFieldUnsuspendentDisabled!!
    }

private var _breakpointFieldUnsuspendentDisabled: IntellijIconData? = null

private fun BreakpointFieldUnsuspendentDisabledComposable(colorScheme: IntelliJIconColors):
        ImageVector = Builder(name = "BreakpointFieldUnsuspendentDisabled", defaultWidth = 14.0.dp,
