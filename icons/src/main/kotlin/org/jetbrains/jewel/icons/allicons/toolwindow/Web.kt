...
public val ToolwindowGroup.Web: IntellijIconData
    get() {
        if (_web != null) {
            return _web!!
        }
        _web = IntellijIconData(name = "Web",size = DpSize(height = 16.0.dp, width =
                16.0.dp),imageVector = { WebComposable(it) })
        return _web!!
    }

private var _web: IntellijIconData? = null

private fun WebComposable(colorScheme: IntelliJIconColors): ImageVector = Builder(name = "Web",
