...
public val NodesGroup.WarningIntroduction: IntellijIconData
    get() {
        ...
        _warningIntroduction = IntellijIconData(name = "WarningIntroduction",size = DpSize(height =
                16.0.dp, width = 16.0.dp),imageVector = { WarningIntroductionComposable(it) })
        return _warningIntroduction!!
    }
...
private fun WarningIntroductionComposable(colorScheme: IntelliJIconColors): ImageVector =
    ...
    path(fill = SolidColor(colorScheme.yellowStroke), stroke = null, strokeLineWidth = 0.0f,
