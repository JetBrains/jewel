...
public val ToolwindowGroup.MeetNewUi_20x20: IntellijIconData
    get() {
        if (_meetNewUi_20x20 != null) {
            return _meetNewUi_20x20!!
        }
        _meetNewUi_20x20 = IntellijIconData(name = "MeetNewUi_20x20",size = DpSize(height = 20.0.dp,
                width = 20.0.dp),imageVector = { MeetNewUi_20x20Composable(it) })
        return _meetNewUi_20x20!!
    }

private var _meetNewUi_20x20: IntellijIconData? = null

private fun MeetNewUi_20x20Composable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "MeetNewUi_20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp, viewportWidth = 20.0f,
