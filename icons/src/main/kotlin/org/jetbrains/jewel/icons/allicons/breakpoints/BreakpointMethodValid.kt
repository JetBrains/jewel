...
public val BreakpointsGroup.BreakpointMethodValid: IntellijIconData
    get() {
        if (_breakpointMethodValid != null) {
            return _breakpointMethodValid!!
        }
        _breakpointMethodValid = IntellijIconData(name = "BreakpointMethodValid",size =
                DpSize(height = 14.0.dp, width = 14.0.dp),imageVector = {
                BreakpointMethodValidComposable(it) })
        return _breakpointMethodValid!!
    }

private var _breakpointMethodValid: IntellijIconData? = null

private fun BreakpointMethodValidComposable(colorScheme: IntelliJIconColors): ImageVector =
        Builder(name = "BreakpointMethodValid", defaultWidth = 14.0.dp, defaultHeight = 14.0.dp,
