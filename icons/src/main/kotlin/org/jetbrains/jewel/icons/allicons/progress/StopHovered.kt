...
public val ProgressGroup.StopHovered: IntellijIconData
    get() {
        if (_stopHovered != null) {
            return _stopHovered!!
        }
        _stopHovered = IntellijIconData(name = "StopHovered",size = DpSize(height = 16.0.dp, width =
                16.0.dp),imageVector = { StopHoveredComposable(it) })
        return _stopHovered!!
    }

private var _stopHovered: IntellijIconData? = null

private fun StopHoveredComposable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "StopHovered", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp, viewportWidth = 16.0f,
