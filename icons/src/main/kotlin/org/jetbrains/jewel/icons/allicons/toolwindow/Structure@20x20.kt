...
public val ToolwindowGroup.`Structure@20x20`: IntellijIconData
    get() {
        if (`_structure@20x20` != null) {
            return `_structure@20x20`!!
        }
        `_structure@20x20` = IntellijIconData(imageVector = { `Structure@20x20Composable`(it) })
        return `_structure@20x20`!!
    }

private var `_structure@20x20`: IntellijIconData? = null

private fun `Structure@20x20Composable`(colorScheme: IntelliJIconColors): ImageVector = Builder(name
        = "Structure@20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp, viewportWidth = 20.0f,
