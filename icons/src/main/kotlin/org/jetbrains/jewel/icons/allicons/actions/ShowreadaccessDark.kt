...
public val ActionsGroup.ShowreadaccessDark: ImageVector
    get() {
        if (_showreadaccessDark != null) {
            return _showreadaccessDark!!
        }
        _showreadaccessDark = Builder(name = "ShowreadaccessDark", defaultWidth = 16.0.dp,
