...
public val ActionsGroup.Lightning: IntellijIconData
    get() {
        if (_lightning != null) {
            return _lightning!!
        }
        _lightning = IntellijIconData(name = "Lightning",size = DpSize(height = 16.0.dp, width =
                16.0.dp),imageVector = { LightningComposable(it) })
        return _lightning!!
    }

private var _lightning: IntellijIconData? = null

private fun LightningComposable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "Lightning", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp, viewportWidth = 16.0f,
