...
public val VcsGroup.Update: IntellijIconData
    get() {
        if (_update != null) {
            return _update!!
        }
        _update = IntellijIconData(name = "Update",size = DpSize(height = 16.0.dp, width =
                16.0.dp),imageVector = { UpdateComposable(it) })
        return _update!!
    }

private var _update: IntellijIconData? = null

private fun UpdateComposable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "Update", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp, viewportWidth = 16.0f,
