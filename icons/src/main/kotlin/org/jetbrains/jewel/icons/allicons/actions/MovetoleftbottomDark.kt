...
public val ActionsGroup.MovetoleftbottomDark: ImageVector
    get() {
        if (_movetoleftbottomDark != null) {
            return _movetoleftbottomDark!!
        }
        _movetoleftbottomDark = Builder(name = "MovetoleftbottomDark", defaultWidth = 16.0.dp,
