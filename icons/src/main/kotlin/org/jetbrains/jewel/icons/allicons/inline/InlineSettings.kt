...
public val InlineGroup.InlineSettings: IntellijIconData
    get() {
        if (_inlineSettings != null) {
            return _inlineSettings!!
        }
        _inlineSettings = IntellijIconData(name = "InlineSettings",size = DpSize(height = 16.0.dp,
                width = 16.0.dp),imageVector = { InlineSettingsComposable(it) })
        return _inlineSettings!!
    }

private var _inlineSettings: IntellijIconData? = null

private fun InlineSettingsComposable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "InlineSettings", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp, viewportWidth = 16.0f,
