...
public val VcsGroup.CurrentBranchLabel: IntellijIconData
    get() {
        if (_currentBranchLabel != null) {
            return _currentBranchLabel!!
        }
        _currentBranchLabel = IntellijIconData(name = "CurrentBranchLabel",size = DpSize(height =
                16.0.dp, width = 16.0.dp),imageVector = { CurrentBranchLabelComposable(it) })
        return _currentBranchLabel!!
    }

private var _currentBranchLabel: IntellijIconData? = null
