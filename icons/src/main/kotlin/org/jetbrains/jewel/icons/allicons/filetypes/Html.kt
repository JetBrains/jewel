...
public val FiletypesGroup.Html: IntellijIconData
    get() {
        if (_html != null) {
            return _html!!
        }
        _html = IntellijIconData(name = "Html",size = DpSize(height = 16.0.dp, width =
                16.0.dp),imageVector = { HtmlComposable(it) })
        return _html!!
    }

private var _html: IntellijIconData? = null

private fun HtmlComposable(colorScheme: IntelliJIconColors): ImageVector = Builder(name = "Html",
