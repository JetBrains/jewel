...
public val ActionsGroup.TogglevisibilityDark: ImageVector
    get() {
        if (_togglevisibilityDark != null) {
            return _togglevisibilityDark!!
        }
        _togglevisibilityDark = Builder(name = "TogglevisibilityDark", defaultWidth = 16.0.dp,
...
private var _togglevisibilityDark: ImageVector? = null
