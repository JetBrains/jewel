...
public val GeneralGroup.Settings: IntellijIconData
    get() {
        if (_settings != null) {
            return _settings!!
        }
        _settings = IntellijIconData(name = "Settings",size = DpSize(height = 16.0.dp, width =
                16.0.dp),imageVector = { SettingsComposable(it) })
        return _settings!!
    }

private var _settings: IntellijIconData? = null

private fun SettingsComposable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "Settings", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp, viewportWidth = 16.0f,
