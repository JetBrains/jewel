...
public val ToolwindowGroup.`Vcs@20x20`: IntellijIconData
    get() {
        if (`_vcs@20x20` != null) {
            return `_vcs@20x20`!!
        }
        `_vcs@20x20` = IntellijIconData(imageVector = { `Vcs@20x20Composable`(it) })
        return `_vcs@20x20`!!
    }

private var `_vcs@20x20`: IntellijIconData? = null

private fun `Vcs@20x20Composable`(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "Vcs@20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp, viewportWidth = 20.0f,
