...
public val ActionsGroup.DiffwithclipboardDark: ImageVector
    get() {
        if (_diffwithclipboardDark != null) {
            return _diffwithclipboardDark!!
        }
        _diffwithclipboardDark = Builder(name = "DiffwithclipboardDark", defaultWidth = 16.0.dp,
                defaultHeight = 16.0.dp, viewportWidth = 16.0f, viewportHeight = 16.0f).apply {
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF548AF7)),
...
private var _diffwithclipboardDark: ImageVector? = null
