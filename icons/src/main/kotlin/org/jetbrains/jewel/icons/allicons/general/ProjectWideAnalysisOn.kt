...
public val GeneralGroup.ProjectWideAnalysisOn: IntellijIconData
    get() {
        if (_projectWideAnalysisOn != null) {
            return _projectWideAnalysisOn!!
        }
        _projectWideAnalysisOn = IntellijIconData(name = "ProjectWideAnalysisOn",size =
                DpSize(height = 16.0.dp, width = 16.0.dp),imageVector = {
                ProjectWideAnalysisOnComposable(it) })
        return _projectWideAnalysisOn!!
    }

private var _projectWideAnalysisOn: IntellijIconData? = null

private fun ProjectWideAnalysisOnComposable(colorScheme: IntelliJIconColors): ImageVector =
        Builder(name = "ProjectWideAnalysisOn", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
