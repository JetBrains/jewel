...
import org.jetbrains.jewel.icons.allicons.vcs.ChangesPush_12x12
import org.jetbrains.jewel.icons.allicons.vcs.ChangesUpdate_12x12
...
import org.jetbrains.jewel.icons.allicons.vcs.Fetch_20x20
...
import org.jetbrains.jewel.icons.allicons.vcs.Push_20x20
...
import org.jetbrains.jewel.icons.allicons.vcs.Update_20x20
...
public val VcsGroup.AllAssets: ____KtList<IntellijIconData>
  ...
  get() {
    ...
    __AllAssets= listOf(CurrentBranchFavoriteLabel, Push_20x20, Revert, OutgoingPush, Commit,
        Update_20x20, Unshelve, Diff, Update, Stash, Fetch_20x20, CurrentBranchLabel, IntelliSort,
        Changelist, CherryPick, IncomingUpdate, Changes, Push, ChangesUpdate_12x12, Fetch, Patch,
        Vcs, ChangesPush_12x12, Merge, BranchLabel)
    return __AllAssets!!
  }
