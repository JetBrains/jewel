...
public val ActionsGroup.Togglevisibility: ImageVector
    get() {
        if (_togglevisibility != null) {
            return _togglevisibility!!
        }
        _togglevisibility = Builder(name = "Togglevisibility", defaultWidth = 16.0.dp, defaultHeight
...
private var _togglevisibility: ImageVector? = null
