...
public val CodeinsightGroup.InlayRenameInComments: IntellijIconData
    get() {
        if (_inlayRenameInComments != null) {
            return _inlayRenameInComments!!
        }
        _inlayRenameInComments = IntellijIconData(name = "InlayRenameInComments",size =
                DpSize(height = 12.0.dp, width = 12.0.dp),imageVector = {
                InlayRenameInCommentsComposable(it) })
        return _inlayRenameInComments!!
    }

private var _inlayRenameInComments: IntellijIconData? = null

private fun InlayRenameInCommentsComposable(colorScheme: IntelliJIconColors): ImageVector =
        Builder(name = "InlayRenameInComments", defaultWidth = 12.0.dp, defaultHeight = 12.0.dp,
