...
public val ActionsGroup.Diffwithclipboard: ImageVector
    get() {
        if (_diffwithclipboard != null) {
            return _diffwithclipboard!!
        }
        _diffwithclipboard = Builder(name = "Diffwithclipboard", defaultWidth = 16.0.dp,
...
private var _diffwithclipboard: ImageVector? = null
