...
public val ToolwindowGroup.`Commit@20x20`: IntellijIconData
    get() {
        if (`_commit@20x20` != null) {
            return `_commit@20x20`!!
        }
        `_commit@20x20` = IntellijIconData(imageVector = { `Commit@20x20Composable`(it) })
        return `_commit@20x20`!!
    }

private var `_commit@20x20`: IntellijIconData? = null

private fun `Commit@20x20Composable`(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "Commit@20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp, viewportWidth = 20.0f,
