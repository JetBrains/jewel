...
public val ActionsGroup.MoveToBottomLeft: IntellijIconData
    get() {
        if (_moveToBottomLeft != null) {
            return _moveToBottomLeft!!
        }
        _moveToBottomLeft = IntellijIconData(name = "MoveToBottomLeft",size = DpSize(height =
                16.0.dp, width = 16.0.dp),imageVector = { MoveToBottomLeftComposable(it) })
        return _moveToBottomLeft!!
    }

private var _moveToBottomLeft: IntellijIconData? = null

private fun MoveToBottomLeftComposable(colorScheme: IntelliJIconColors): ImageVector = Builder(name
        = "MoveToBottomLeft", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp, viewportWidth =
