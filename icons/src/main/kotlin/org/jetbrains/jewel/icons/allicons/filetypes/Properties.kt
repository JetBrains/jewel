...
public val FiletypesGroup.Properties: IntellijIconData
    get() {
        if (_properties != null) {
            return _properties!!
        }
        _properties = IntellijIconData(name = "Properties",size = DpSize(height = 16.0.dp, width =
                16.0.dp),imageVector = { PropertiesComposable(it) })
        return _properties!!
    }

private var _properties: IntellijIconData? = null

private fun PropertiesComposable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "Properties", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp, viewportWidth = 16.0f,
