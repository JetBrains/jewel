...
public val ActionsGroup.MovetorighttopDark: ImageVector
    get() {
        if (_movetorighttopDark != null) {
            return _movetorighttopDark!!
        }
        _movetorighttopDark = Builder(name = "MovetorighttopDark", defaultWidth = 16.0.dp,
