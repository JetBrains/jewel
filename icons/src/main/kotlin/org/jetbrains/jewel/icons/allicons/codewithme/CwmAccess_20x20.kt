...
public val CodewithmeGroup.CwmAccess_20x20: IntellijIconData
    get() {
        if (_cwmAccess_20x20 != null) {
            return _cwmAccess_20x20!!
        }
        _cwmAccess_20x20 = IntellijIconData(name = "CwmAccess_20x20",size = DpSize(height = 20.0.dp,
                width = 20.0.dp),imageVector = { CwmAccess_20x20Composable(it) })
        return _cwmAccess_20x20!!
    }

private var _cwmAccess_20x20: IntellijIconData? = null

private fun CwmAccess_20x20Composable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "CwmAccess_20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp, viewportWidth = 20.0f,
