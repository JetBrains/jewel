...
public val ActionsGroup.Showreadaccess: ImageVector
    get() {
        if (_showreadaccess != null) {
            return _showreadaccess!!
        }
        _showreadaccess = Builder(name = "Showreadaccess", defaultWidth = 16.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF369650)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
