...
public val ToolwindowGroup.`Web@20x20`: IntellijIconData
    get() {
        if (`_web@20x20` != null) {
            return `_web@20x20`!!
        }
        `_web@20x20` = IntellijIconData(imageVector = { `Web@20x20Composable`(it) })
        return `_web@20x20`!!
    }

private var `_web@20x20`: IntellijIconData? = null

private fun `Web@20x20Composable`(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "Web@20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp, viewportWidth = 20.0f,
