...
public val ToolwindowGroup.`Profiler@20x20`: IntellijIconData
    get() {
        if (`_profiler@20x20` != null) {
            return `_profiler@20x20`!!
        }
        `_profiler@20x20` = IntellijIconData(imageVector = { `Profiler@20x20Composable`(it) })
        return `_profiler@20x20`!!
    }

private var `_profiler@20x20`: IntellijIconData? = null

private fun `Profiler@20x20Composable`(colorScheme: IntelliJIconColors): ImageVector = Builder(name
        = "Profiler@20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp, viewportWidth = 20.0f,
