...
public val VcsGroup.`ChangesUpdate@12x12`: IntellijIconData
    get() {
        if (`_changesUpdate@12x12` != null) {
            return `_changesUpdate@12x12`!!
        }
        `_changesUpdate@12x12` = IntellijIconData(imageVector = {
                `ChangesUpdate@12x12Composable`(it) })
        return `_changesUpdate@12x12`!!
    }

private var `_changesUpdate@12x12`: IntellijIconData? = null

private fun `ChangesUpdate@12x12Composable`(colorScheme: IntelliJIconColors): ImageVector =
        Builder(name = "ChangesUpdate@12x12", defaultWidth = 12.0.dp, defaultHeight = 12.0.dp,
