...
public val NodesGroup.Parameter: IntellijIconData
    get() {
        if (_parameter != null) {
            return _parameter!!
        }
        _parameter = IntellijIconData(name = "Parameter",size = DpSize(height = 16.0.dp, width =
                16.0.dp),imageVector = { ParameterComposable(it) })
        return _parameter!!
    }

private var _parameter: IntellijIconData? = null
