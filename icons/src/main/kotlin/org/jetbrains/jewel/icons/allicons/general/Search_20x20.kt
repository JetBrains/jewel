...
public val GeneralGroup.Search_20x20: IntellijIconData
    get() {
        if (_search_20x20 != null) {
            return _search_20x20!!
        }
        _search_20x20 = IntellijIconData(name = "Search_20x20",size = DpSize(height = 20.0.dp, width
                = 20.0.dp),imageVector = { Search_20x20Composable(it) })
        return _search_20x20!!
    }

private var _search_20x20: IntellijIconData? = null

private fun Search_20x20Composable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "Search_20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp, viewportWidth = 20.0f,
