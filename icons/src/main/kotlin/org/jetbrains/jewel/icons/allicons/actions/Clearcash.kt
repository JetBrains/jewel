...
public val ActionsGroup.Clearcash: ImageVector
    get() {
        if (_clearcash != null) {
            return _clearcash!!
        }
        _clearcash = Builder(name = "Clearcash", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
...
private var _clearcash: ImageVector? = null
