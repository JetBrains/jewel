...
public val NodesGroup.Module: IntellijIconData
    get() {
        if (_module != null) {
            return _module!!
        }
        _module = IntellijIconData(name = "Module",size = DpSize(height = 16.0.dp, width =
                16.0.dp),imageVector = { ModuleComposable(it) })
        return _module!!
    }

private var _module: IntellijIconData? = null

private fun ModuleComposable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "Module", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp, viewportWidth = 16.0f,
