...
public val BreakpointsGroup.BreakpointMutedDependent: IntellijIconData
    get() {
        if (_breakpointMutedDependent != null) {
            return _breakpointMutedDependent!!
        }
        _breakpointMutedDependent = IntellijIconData(name = "BreakpointMutedDependent",size =
                DpSize(height = 14.0.dp, width = 14.0.dp),imageVector = {
                BreakpointMutedDependentComposable(it) })
        return _breakpointMutedDependent!!
    }

private var _breakpointMutedDependent: IntellijIconData? = null

private fun BreakpointMutedDependentComposable(colorScheme: IntelliJIconColors): ImageVector =
        Builder(name = "BreakpointMutedDependent", defaultWidth = 14.0.dp, defaultHeight = 14.0.dp,
