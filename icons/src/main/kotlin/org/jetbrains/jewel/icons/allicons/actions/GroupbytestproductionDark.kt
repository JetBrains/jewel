...
public val ActionsGroup.GroupbytestproductionDark: ImageVector
    get() {
        if (_groupbytestproductionDark != null) {
            return _groupbytestproductionDark!!
        }
        _groupbytestproductionDark = Builder(name = "GroupbytestproductionDark", defaultWidth =
