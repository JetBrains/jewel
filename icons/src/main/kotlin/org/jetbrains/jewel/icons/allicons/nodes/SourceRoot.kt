...
public val NodesGroup.SourceRoot: IntellijIconData
    get() {
        if (_sourceRoot != null) {
            return _sourceRoot!!
        }
        _sourceRoot = IntellijIconData(name = "SourceRoot",size = DpSize(height = 16.0.dp, width =
                16.0.dp),imageVector = { SourceRootComposable(it) })
        return _sourceRoot!!
    }

private var _sourceRoot: IntellijIconData? = null

private fun SourceRootComposable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "SourceRoot", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp, viewportWidth = 16.0f,
