...
public val ToolwindowGroup.Todo_20x20: IntellijIconData
    get() {
        if (_todo_20x20 != null) {
            return _todo_20x20!!
        }
        _todo_20x20 = IntellijIconData(name = "Todo_20x20",size = DpSize(height = 20.0.dp, width =
                20.0.dp),imageVector = { Todo_20x20Composable(it) })
        return _todo_20x20!!
    }

private var _todo_20x20: IntellijIconData? = null

private fun Todo_20x20Composable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "Todo_20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp, viewportWidth = 20.0f,
