...
public val ToolwindowGroup.`Notifications@20x20`: IntellijIconData
    get() {
        if (`_notifications@20x20` != null) {
            return `_notifications@20x20`!!
        }
        `_notifications@20x20` = IntellijIconData(imageVector = {
                `Notifications@20x20Composable`(it) })
        return `_notifications@20x20`!!
    }

private var `_notifications@20x20`: IntellijIconData? = null

private fun `Notifications@20x20Composable`(colorScheme: IntelliJIconColors): ImageVector =
        Builder(name = "Notifications@20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp,
