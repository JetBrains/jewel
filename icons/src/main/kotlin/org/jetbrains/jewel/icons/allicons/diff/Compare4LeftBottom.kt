...
public val DiffGroup.Compare4LeftBottom: IntellijIconData
    get() {
        if (_compare4LeftBottom != null) {
            return _compare4LeftBottom!!
        }
        _compare4LeftBottom = IntellijIconData(name = "Compare4LeftBottom",size = DpSize(height =
                16.0.dp, width = 16.0.dp),imageVector = { Compare4LeftBottomComposable(it) })
        return _compare4LeftBottom!!
    }

private var _compare4LeftBottom: IntellijIconData? = null

private fun Compare4LeftBottomComposable(colorScheme: IntelliJIconColors): ImageVector =
        Builder(name = "Compare4LeftBottom", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
