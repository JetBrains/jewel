...
public val BreakpointsGroup.BreakpointMethodUnsuspendentValid: IntellijIconData
    get() {
        ...
        _breakpointMethodUnsuspendentValid = IntellijIconData(name =
                "BreakpointMethodUnsuspendentValid",size = DpSize(height = 14.0.dp, width =
                14.0.dp),imageVector = { BreakpointMethodUnsuspendentValidComposable(it) })
        return _breakpointMethodUnsuspendentValid!!
    }
