...
public val MeetnewuiGroup.LightTheme: IntellijIconData
    get() {
        if (_lightTheme != null) {
            return _lightTheme!!
        }
        _lightTheme = IntellijIconData(name = "LightTheme",size = DpSize(height = 16.0.dp, width =
                16.0.dp),imageVector = { LightThemeComposable(it) })
        return _lightTheme!!
    }

private var _lightTheme: IntellijIconData? = null

private fun LightThemeComposable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "LightTheme", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp, viewportWidth = 16.0f,
