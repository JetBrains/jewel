...
public val InlineGroup.Refresh: IntellijIconData
    get() {
        if (_refresh != null) {
            return _refresh!!
        }
        _refresh = IntellijIconData(name = "Refresh",size = DpSize(height = 16.0.dp, width =
                18.0.dp),imageVector = { RefreshComposable(it) })
        return _refresh!!
    }
...
private fun RefreshComposable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "Refresh", defaultWidth = 18.0.dp, defaultHeight = 16.0.dp, viewportWidth = 18.0f,
