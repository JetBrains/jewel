...
public val BreakpointsGroup.BreakpointFieldMutedDependent: IntellijIconData
    get() {
        if (_breakpointFieldMutedDependent != null) {
            return _breakpointFieldMutedDependent!!
        }
        _breakpointFieldMutedDependent = IntellijIconData(name =
                "BreakpointFieldMutedDependent",size = DpSize(height = 14.0.dp, width =
                14.0.dp),imageVector = { BreakpointFieldMutedDependentComposable(it) })
        return _breakpointFieldMutedDependent!!
    }

private var _breakpointFieldMutedDependent: IntellijIconData? = null

private fun BreakpointFieldMutedDependentComposable(colorScheme: IntelliJIconColors): ImageVector =
        Builder(name = "BreakpointFieldMutedDependent", defaultWidth = 14.0.dp, defaultHeight =
