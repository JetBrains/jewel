...
public val ToolwindowGroup.`Repositories@20x20`: IntellijIconData
    get() {
        if (`_repositories@20x20` != null) {
            return `_repositories@20x20`!!
        }
        `_repositories@20x20` = IntellijIconData(imageVector = { `Repositories@20x20Composable`(it)
                })
        return `_repositories@20x20`!!
    }

private var `_repositories@20x20`: IntellijIconData? = null

private fun `Repositories@20x20Composable`(colorScheme: IntelliJIconColors): ImageVector =
        Builder(name = "Repositories@20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp,
