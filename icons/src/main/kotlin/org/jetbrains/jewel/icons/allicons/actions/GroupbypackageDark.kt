...
public val ActionsGroup.GroupbypackageDark: ImageVector
    get() {
        if (_groupbypackageDark != null) {
            return _groupbypackageDark!!
        }
        _groupbypackageDark = Builder(name = "GroupbypackageDark", defaultWidth = 16.0.dp,
