...
public val ActionsGroup.GroupByMethod: IntellijIconData
    get() {
        if (_groupByMethod != null) {
            return _groupByMethod!!
        }
        _groupByMethod = IntellijIconData(name = "GroupByMethod",size = DpSize(height = 16.0.dp,
                width = 16.0.dp),imageVector = { GroupByMethodComposable(it) })
        return _groupByMethod!!
    }

private var _groupByMethod: IntellijIconData? = null
