...
public val NodesGroup.Servlet: IntellijIconData
    get() {
        if (_servlet != null) {
            return _servlet!!
        }
        _servlet = IntellijIconData(name = "Servlet",size = DpSize(height = 16.0.dp, width =
                16.0.dp),imageVector = { ServletComposable(it) })
        return _servlet!!
    }

private var _servlet: IntellijIconData? = null

private fun ServletComposable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "Servlet", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp, viewportWidth = 16.0f,
