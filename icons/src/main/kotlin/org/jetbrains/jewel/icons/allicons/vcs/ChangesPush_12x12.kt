...
public val VcsGroup.ChangesPush_12x12: IntellijIconData
    get() {
        if (_changesPush_12x12 != null) {
            return _changesPush_12x12!!
        }
        _changesPush_12x12 = IntellijIconData(name = "ChangesPush_12x12",size = DpSize(height =
                12.0.dp, width = 12.0.dp),imageVector = { ChangesPush_12x12Composable(it) })
        return _changesPush_12x12!!
    }

private var _changesPush_12x12: IntellijIconData? = null

private fun ChangesPush_12x12Composable(colorScheme: IntelliJIconColors): ImageVector = Builder(name
        = "ChangesPush_12x12", defaultWidth = 12.0.dp, defaultHeight = 12.0.dp, viewportWidth =
