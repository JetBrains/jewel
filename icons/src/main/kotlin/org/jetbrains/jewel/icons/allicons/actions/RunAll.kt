...
public val ActionsGroup.RunAll: IntellijIconData
    get() {
        if (_runAll != null) {
            return _runAll!!
        }
        _runAll = IntellijIconData(name = "RunAll",size = DpSize(height = 16.0.dp, width =
                16.0.dp),imageVector = { RunAllComposable(it) })
        return _runAll!!
    }

private var _runAll: IntellijIconData? = null
