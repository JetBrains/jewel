...
public val NodesGroup.Package: IntellijIconData
    get() {
        if (_package != null) {
            return _package!!
        }
        _package = IntellijIconData(name = "Package",size = DpSize(height = 16.0.dp, width =
                16.0.dp),imageVector = { PackageComposable(it) })
        return _package!!
    }

private var _package: IntellijIconData? = null

private fun PackageComposable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "Package", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp, viewportWidth = 16.0f,
