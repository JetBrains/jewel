...
public val MeetnewuiGroup.DarkTheme: IntellijIconData
    get() {
        if (_darkTheme != null) {
            return _darkTheme!!
        }
        _darkTheme = IntellijIconData(name = "DarkTheme",size = DpSize(height = 16.0.dp, width =
                16.0.dp),imageVector = { DarkThemeComposable(it) })
        return _darkTheme!!
    }

private var _darkTheme: IntellijIconData? = null

private fun DarkThemeComposable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "DarkTheme", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp, viewportWidth = 16.0f,
