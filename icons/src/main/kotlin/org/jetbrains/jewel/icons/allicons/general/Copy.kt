...
public val GeneralGroup.Copy: IntellijIconData
    get() {
        if (_copy != null) {
            return _copy!!
        }
        _copy = IntellijIconData(name = "Copy",size = DpSize(height = 16.0.dp, width =
                16.0.dp),imageVector = { CopyComposable(it) })
        return _copy!!
    }

private var _copy: IntellijIconData? = null

private fun CopyComposable(colorScheme: IntelliJIconColors): ImageVector = Builder(name = "Copy",
    ...
    path(fill = SolidColor(colorScheme.generalStroke), stroke = null, strokeLineWidth = 0.0f,
            strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f, pathFillType =
            EvenOdd) {
        moveTo(11.0017f, 2.0f)
        horizontalLineTo(11.5998f)
        curveTo(12.373f, 2.0f, 12.9998f, 2.6268f, 12.9998f, 3.4f)
        verticalLineTo(3.9108f)
        curveTo(13.0011f, 3.9404f, 13.0017f, 3.9701f, 13.0017f, 4.0f)
        verticalLineTo(11.5482f)
        curveTo(13.6063f, 11.1124f, 13.9998f, 10.4021f, 13.9998f, 9.6f)
        verticalLineTo(3.4f)
        curveTo(13.9998f, 2.0745f, 12.9253f, 1.0f, 11.5998f, 1.0f)
        horizontalLineTo(6.3998f)
        curveTo(5.5968f, 1.0f, 4.8859f, 1.3944f, 4.4502f, 2.0f)
        horizontalLineTo(6.3998f)
