...
public val ToolwindowGroup.`Services@20x20`: IntellijIconData
    get() {
        if (`_services@20x20` != null) {
            return `_services@20x20`!!
        }
        `_services@20x20` = IntellijIconData(imageVector = { `Services@20x20Composable`(it) })
        return `_services@20x20`!!
    }

private var `_services@20x20`: IntellijIconData? = null

private fun `Services@20x20Composable`(colorScheme: IntelliJIconColors): ImageVector = Builder(name
        = "Services@20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp, viewportWidth = 20.0f,
