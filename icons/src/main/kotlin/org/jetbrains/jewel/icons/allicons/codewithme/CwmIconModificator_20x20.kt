...
public val CodewithmeGroup.CwmIconModificator_20x20: IntellijIconData
    get() {
        if (_cwmIconModificator_20x20 != null) {
            return _cwmIconModificator_20x20!!
        }
        _cwmIconModificator_20x20 = IntellijIconData(name = "CwmIconModificator_20x20",size =
                DpSize(height = 22.0.dp, width = 22.0.dp),imageVector = {
                CwmIconModificator_20x20Composable(it) })
        return _cwmIconModificator_20x20!!
    }

private var _cwmIconModificator_20x20: IntellijIconData? = null

private fun CwmIconModificator_20x20Composable(colorScheme: IntelliJIconColors): ImageVector =
        Builder(name = "CwmIconModificator_20x20", defaultWidth = 22.0.dp, defaultHeight = 22.0.dp,
