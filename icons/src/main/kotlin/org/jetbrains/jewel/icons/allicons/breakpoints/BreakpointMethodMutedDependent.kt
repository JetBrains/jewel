...
public val BreakpointsGroup.BreakpointMethodMutedDependent: IntellijIconData
    get() {
        if (_breakpointMethodMutedDependent != null) {
            return _breakpointMethodMutedDependent!!
        }
        _breakpointMethodMutedDependent = IntellijIconData(name =
                "BreakpointMethodMutedDependent",size = DpSize(height = 14.0.dp, width =
                14.0.dp),imageVector = { BreakpointMethodMutedDependentComposable(it) })
        return _breakpointMethodMutedDependent!!
    }

private var _breakpointMethodMutedDependent: IntellijIconData? = null

private fun BreakpointMethodMutedDependentComposable(colorScheme: IntelliJIconColors): ImageVector =
        Builder(name = "BreakpointMethodMutedDependent", defaultWidth = 14.0.dp, defaultHeight =
