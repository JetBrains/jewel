...
public val BreakpointsGroup.BreakpointUnsuspendentValid: IntellijIconData
    get() {
        if (_breakpointUnsuspendentValid != null) {
            return _breakpointUnsuspendentValid!!
        }
        _breakpointUnsuspendentValid = IntellijIconData(name = "BreakpointUnsuspendentValid",size =
                DpSize(height = 14.0.dp, width = 14.0.dp),imageVector = {
                BreakpointUnsuspendentValidComposable(it) })
        return _breakpointUnsuspendentValid!!
    }

private var _breakpointUnsuspendentValid: IntellijIconData? = null

private fun BreakpointUnsuspendentValidComposable(colorScheme: IntelliJIconColors): ImageVector =
        Builder(name = "BreakpointUnsuspendentValid", defaultWidth = 14.0.dp, defaultHeight =
