...
public val GutterGroup.SuggestedRefactoringDisabled: IntellijIconData
    get() {
        if (_suggestedRefactoringDisabled != null) {
            return _suggestedRefactoringDisabled!!
        }
        _suggestedRefactoringDisabled = IntellijIconData(name = "SuggestedRefactoringDisabled",size
                = DpSize(height = 14.0.dp, width = 14.0.dp),imageVector = {
                SuggestedRefactoringDisabledComposable(it) })
        return _suggestedRefactoringDisabled!!
    }

private var _suggestedRefactoringDisabled: IntellijIconData? = null

private fun SuggestedRefactoringDisabledComposable(colorScheme: IntelliJIconColors): ImageVector =
        Builder(name = "SuggestedRefactoringDisabled", defaultWidth = 14.0.dp, defaultHeight =
        14.0.dp, viewportWidth = 14.0f, viewportHeight = 14.0f).apply {
    path(fill = SolidColor(Color(0xFFC9CCD6)), stroke = null, strokeLineWidth = 0.0f, strokeLineCap
            = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f, pathFillType = EvenOdd) {
        moveTo(4.0f, 14.0f)
        verticalLineTo(11.0f)
        lineTo(10.7031f, 4.2969f)
        curveTo(11.0937f, 3.9063f, 11.7268f, 3.9063f, 12.1173f, 4.2969f)
        lineTo(13.7031f, 5.8826f)
        curveTo(14.0937f, 6.2732f, 14.0937f, 6.9063f, 13.7031f, 7.2969f)
        lineTo(7.0f, 14.0f)
        horizontalLineTo(4.0f)
        close()
        moveTo(5.0f, 13.0f)
        verticalLineTo(11.4142f)
        lineTo(9.3535f, 7.0606f)
        lineTo(10.9393f, 8.6464f)
        lineTo(6.5858f, 13.0f)
        horizontalLineTo(5.0f)
        close()
        moveTo(11.6464f, 7.9393f)
        lineTo(12.996f, 6.5897f)
        lineTo(11.4102f, 5.004f)
        lineTo(10.0607f, 6.3535f)
        lineTo(11.6464f, 7.9393f)
        close()
    }
    path(fill = SolidColor(Color(0xFFC9CCD6)), stroke = null, strokeLineWidth = 0.0f, strokeLineCap
            = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f, pathFillType = EvenOdd) {
