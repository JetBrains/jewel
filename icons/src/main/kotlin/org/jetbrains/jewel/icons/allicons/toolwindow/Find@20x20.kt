...
public val ToolwindowGroup.`Find@20x20`: IntellijIconData
    get() {
        if (`_find@20x20` != null) {
            return `_find@20x20`!!
        }
        `_find@20x20` = IntellijIconData(imageVector = { `Find@20x20Composable`(it) })
        return `_find@20x20`!!
    }

private var `_find@20x20`: IntellijIconData? = null

private fun `Find@20x20Composable`(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "Find@20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp, viewportWidth = 20.0f,
