...
public val ActionsGroup.MovetorightbottomDark: ImageVector
    get() {
        if (_movetorightbottomDark != null) {
            return _movetorightbottomDark!!
        }
        _movetorightbottomDark = Builder(name = "MovetorightbottomDark", defaultWidth = 16.0.dp,
