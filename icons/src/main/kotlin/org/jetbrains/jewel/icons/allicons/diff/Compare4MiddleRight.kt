...
public val DiffGroup.Compare4MiddleRight: IntellijIconData
    get() {
        if (_compare4MiddleRight != null) {
            return _compare4MiddleRight!!
        }
        _compare4MiddleRight = IntellijIconData(name = "Compare4MiddleRight",size = DpSize(height =
                16.0.dp, width = 16.0.dp),imageVector = { Compare4MiddleRightComposable(it) })
        return _compare4MiddleRight!!
    }

private var _compare4MiddleRight: IntellijIconData? = null

private fun Compare4MiddleRightComposable(colorScheme: IntelliJIconColors): ImageVector =
        Builder(name = "Compare4MiddleRight", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
