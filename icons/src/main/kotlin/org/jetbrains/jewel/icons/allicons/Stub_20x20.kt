...
public val AllIcons.Stub_20x20: IntellijIconData
    get() {
        if (_stub_20x20 != null) {
            return _stub_20x20!!
        }
        _stub_20x20 = IntellijIconData(name = "Stub_20x20",size = DpSize(height = 20.0.dp, width =
                20.0.dp),imageVector = { Stub_20x20Composable(it) })
        return _stub_20x20!!
    }

private var _stub_20x20: IntellijIconData? = null

private fun Stub_20x20Composable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "Stub_20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp, viewportWidth = 20.0f,
