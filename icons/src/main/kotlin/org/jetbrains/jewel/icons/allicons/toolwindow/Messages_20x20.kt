...
public val ToolwindowGroup.Messages_20x20: IntellijIconData
    get() {
        if (_messages_20x20 != null) {
            return _messages_20x20!!
        }
        _messages_20x20 = IntellijIconData(name = "Messages_20x20",size = DpSize(height = 20.0.dp,
                width = 20.0.dp),imageVector = { Messages_20x20Composable(it) })
        return _messages_20x20!!
    }

private var _messages_20x20: IntellijIconData? = null

private fun Messages_20x20Composable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "Messages_20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp, viewportWidth = 20.0f,
