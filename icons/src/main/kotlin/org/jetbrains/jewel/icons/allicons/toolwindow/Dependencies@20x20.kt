...
public val ToolwindowGroup.`Dependencies@20x20`: IntellijIconData
    get() {
        if (`_dependencies@20x20` != null) {
            return `_dependencies@20x20`!!
        }
        `_dependencies@20x20` = IntellijIconData(imageVector = { `Dependencies@20x20Composable`(it)
                })
        return `_dependencies@20x20`!!
    }

private var `_dependencies@20x20`: IntellijIconData? = null

private fun `Dependencies@20x20Composable`(colorScheme: IntelliJIconColors): ImageVector =
        Builder(name = "Dependencies@20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp,
