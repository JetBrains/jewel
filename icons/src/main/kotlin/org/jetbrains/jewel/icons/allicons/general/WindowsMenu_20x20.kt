...
public val GeneralGroup.WindowsMenu_20x20: IntellijIconData
    get() {
        if (_windowsMenu_20x20 != null) {
            return _windowsMenu_20x20!!
        }
        _windowsMenu_20x20 = IntellijIconData(name = "WindowsMenu_20x20",size = DpSize(height =
                20.0.dp, width = 20.0.dp),imageVector = { WindowsMenu_20x20Composable(it) })
        return _windowsMenu_20x20!!
    }

private var _windowsMenu_20x20: IntellijIconData? = null

private fun WindowsMenu_20x20Composable(colorScheme: IntelliJIconColors): ImageVector = Builder(name
        = "WindowsMenu_20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp, viewportWidth =
