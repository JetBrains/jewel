...
public val ToolwindowGroup.`Bookmarks@20x20`: IntellijIconData
    get() {
        if (`_bookmarks@20x20` != null) {
            return `_bookmarks@20x20`!!
        }
        `_bookmarks@20x20` = IntellijIconData(imageVector = { `Bookmarks@20x20Composable`(it) })
        return `_bookmarks@20x20`!!
    }

private var `_bookmarks@20x20`: IntellijIconData? = null

private fun `Bookmarks@20x20Composable`(colorScheme: IntelliJIconColors): ImageVector = Builder(name
        = "Bookmarks@20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp, viewportWidth = 20.0f,
