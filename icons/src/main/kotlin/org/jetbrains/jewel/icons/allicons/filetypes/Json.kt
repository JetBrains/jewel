...
public val FiletypesGroup.Json: IntellijIconData
    get() {
        if (_json != null) {
            return _json!!
        }
        _json = IntellijIconData(name = "Json",size = DpSize(height = 16.0.dp, width =
                16.0.dp),imageVector = { JsonComposable(it) })
        return _json!!
    }

private var _json: IntellijIconData? = null

private fun JsonComposable(colorScheme: IntelliJIconColors): ImageVector = Builder(name = "Json",
