...
public val CodeinsightGroup.QuickfixOffBulb: IntellijIconData
    get() {
        if (_quickfixOffBulb != null) {
            return _quickfixOffBulb!!
        }
        _quickfixOffBulb = IntellijIconData(name = "QuickfixOffBulb",size = DpSize(height = 16.0.dp,
                width = 16.0.dp),imageVector = { QuickfixOffBulbComposable(it) })
        return _quickfixOffBulb!!
    }

private var _quickfixOffBulb: IntellijIconData? = null

private fun QuickfixOffBulbComposable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "QuickfixOffBulb", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp, viewportWidth = 16.0f,
