...
public val FiletypesGroup.SourceMap: IntellijIconData
    get() {
        if (_sourceMap != null) {
            return _sourceMap!!
        }
        _sourceMap = IntellijIconData(name = "SourceMap",size = DpSize(height = 16.0.dp, width =
                16.0.dp),imageVector = { SourceMapComposable(it) })
        return _sourceMap!!
    }

private var _sourceMap: IntellijIconData? = null

private fun SourceMapComposable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "SourceMap", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp, viewportWidth = 16.0f,
