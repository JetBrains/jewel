...
public val DiffGroup.MagicResolve_14x14: IntellijIconData
    get() {
        if (_magicResolve_14x14 != null) {
            return _magicResolve_14x14!!
        }
        _magicResolve_14x14 = IntellijIconData(name = "MagicResolve_14x14",size = DpSize(height =
                14.0.dp, width = 14.0.dp),imageVector = { MagicResolve_14x14Composable(it) })
        return _magicResolve_14x14!!
    }

private var _magicResolve_14x14: IntellijIconData? = null

private fun MagicResolve_14x14Composable(colorScheme: IntelliJIconColors): ImageVector =
        Builder(name = "MagicResolve_14x14", defaultWidth = 14.0.dp, defaultHeight = 14.0.dp,
