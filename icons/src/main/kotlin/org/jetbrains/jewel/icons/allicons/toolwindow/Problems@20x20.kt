...
public val ToolwindowGroup.`Problems@20x20`: IntellijIconData
    get() {
        if (`_problems@20x20` != null) {
            return `_problems@20x20`!!
        }
        `_problems@20x20` = IntellijIconData(imageVector = { `Problems@20x20Composable`(it) })
        return `_problems@20x20`!!
    }

private var `_problems@20x20`: IntellijIconData? = null

private fun `Problems@20x20Composable`(colorScheme: IntelliJIconColors): ImageVector = Builder(name
        = "Problems@20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp, viewportWidth = 20.0f,
