...
public val VcsGroup.Push: IntellijIconData
    get() {
        if (_push != null) {
            return _push!!
        }
        _push = IntellijIconData(name = "Push",size = DpSize(height = 16.0.dp, width =
                16.0.dp),imageVector = { PushComposable(it) })
        return _push!!
    }

private var _push: IntellijIconData? = null

private fun PushComposable(colorScheme: IntelliJIconColors): ImageVector = Builder(name = "Push",
