...
public val ActionsGroup.MovetobottomrightDark: ImageVector
    get() {
        if (_movetobottomrightDark != null) {
            return _movetobottomrightDark!!
        }
        _movetobottomrightDark = Builder(name = "MovetobottomrightDark", defaultWidth = 16.0.dp,
