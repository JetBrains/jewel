...
public val ToolwindowGroup.`PythonConsole@20x20`: IntellijIconData
    get() {
        if (`_pythonConsole@20x20` != null) {
            return `_pythonConsole@20x20`!!
        }
        `_pythonConsole@20x20` = IntellijIconData(imageVector = {
                `PythonConsole@20x20Composable`(it) })
        return `_pythonConsole@20x20`!!
    }

private var `_pythonConsole@20x20`: IntellijIconData? = null

private fun `PythonConsole@20x20Composable`(colorScheme: IntelliJIconColors): ImageVector =
        Builder(name = "PythonConsole@20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp,
