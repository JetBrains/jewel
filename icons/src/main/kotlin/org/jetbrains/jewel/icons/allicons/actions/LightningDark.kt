...
public val ActionsGroup.LightningDark: ImageVector
    get() {
        if (_lightningDark != null) {
            return _lightningDark!!
        }
        _lightningDark = Builder(name = "LightningDark", defaultWidth = 16.0.dp, defaultHeight =
                16.0.dp, viewportWidth = 16.0f, viewportHeight = 16.0f).apply {
            path(fill = SolidColor(Color(0xFFC77D55)), stroke = null, strokeLineWidth = 0.0f,
