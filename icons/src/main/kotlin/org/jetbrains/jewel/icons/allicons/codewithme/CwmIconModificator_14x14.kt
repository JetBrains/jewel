...
public val CodewithmeGroup.CwmIconModificator_14x14: IntellijIconData
    get() {
        if (_cwmIconModificator_14x14 != null) {
            return _cwmIconModificator_14x14!!
        }
        _cwmIconModificator_14x14 = IntellijIconData(name = "CwmIconModificator_14x14",size =
                DpSize(height = 15.0.dp, width = 15.0.dp),imageVector = {
                CwmIconModificator_14x14Composable(it) })
        return _cwmIconModificator_14x14!!
    }

private var _cwmIconModificator_14x14: IntellijIconData? = null

private fun CwmIconModificator_14x14Composable(colorScheme: IntelliJIconColors): ImageVector =
        Builder(name = "CwmIconModificator_14x14", defaultWidth = 15.0.dp, defaultHeight = 15.0.dp,
