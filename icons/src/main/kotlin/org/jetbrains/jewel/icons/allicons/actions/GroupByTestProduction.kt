...
public val ActionsGroup.GroupByTestProduction: IntellijIconData
    get() {
        if (_groupByTestProduction != null) {
            return _groupByTestProduction!!
        }
        _groupByTestProduction = IntellijIconData(name = "GroupByTestProduction",size =
                DpSize(height = 16.0.dp, width = 16.0.dp),imageVector = {
                GroupByTestProductionComposable(it) })
        return _groupByTestProduction!!
    }

private var _groupByTestProduction: IntellijIconData? = null

private fun GroupByTestProductionComposable(colorScheme: IntelliJIconColors): ImageVector =
        Builder(name = "GroupByTestProduction", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
