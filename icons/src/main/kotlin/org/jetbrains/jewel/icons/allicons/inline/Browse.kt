...
public val InlineGroup.Browse: IntellijIconData
    get() {
        if (_browse != null) {
            return _browse!!
        }
        _browse = IntellijIconData(name = "Browse",size = DpSize(height = 16.0.dp, width =
                16.0.dp),imageVector = { BrowseComposable(it) })
        return _browse!!
    }

private var _browse: IntellijIconData? = null

private fun BrowseComposable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "Browse", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp, viewportWidth = 16.0f,
