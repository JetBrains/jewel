...
public val ToolwindowGroup.Build_20x20: IntellijIconData
    get() {
        if (_build_20x20 != null) {
            return _build_20x20!!
        }
        _build_20x20 = IntellijIconData(name = "Build_20x20",size = DpSize(height = 20.0.dp, width =
                20.0.dp),imageVector = { Build_20x20Composable(it) })
        return _build_20x20!!
    }

private var _build_20x20: IntellijIconData? = null

private fun Build_20x20Composable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "Build_20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp, viewportWidth = 20.0f,
