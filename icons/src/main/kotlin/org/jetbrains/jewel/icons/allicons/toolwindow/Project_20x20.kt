...
public val ToolwindowGroup.Project_20x20: IntellijIconData
    get() {
        if (_project_20x20 != null) {
            return _project_20x20!!
        }
        _project_20x20 = IntellijIconData(name = "Project_20x20",size = DpSize(height = 20.0.dp,
                width = 20.0.dp),imageVector = { Project_20x20Composable(it) })
        return _project_20x20!!
    }

private var _project_20x20: IntellijIconData? = null

private fun Project_20x20Composable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "Project_20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp, viewportWidth = 20.0f,
