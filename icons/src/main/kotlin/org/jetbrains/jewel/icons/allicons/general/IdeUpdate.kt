...
public val GeneralGroup.IdeUpdate: IntellijIconData
    get() {
        if (_ideUpdate != null) {
            return _ideUpdate!!
        }
        _ideUpdate = IntellijIconData(name = "IdeUpdate",size = DpSize(height = 16.0.dp, width =
                16.0.dp),imageVector = { IdeUpdateComposable(it) })
        return _ideUpdate!!
    }

private var _ideUpdate: IntellijIconData? = null

private fun IdeUpdateComposable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "IdeUpdate", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp, viewportWidth = 16.0f,
