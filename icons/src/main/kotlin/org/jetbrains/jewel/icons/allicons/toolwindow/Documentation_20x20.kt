...
public val ToolwindowGroup.Documentation_20x20: IntellijIconData
    get() {
        if (_documentation_20x20 != null) {
            return _documentation_20x20!!
        }
        _documentation_20x20 = IntellijIconData(name = "Documentation_20x20",size = DpSize(height =
                20.0.dp, width = 20.0.dp),imageVector = { Documentation_20x20Composable(it) })
        return _documentation_20x20!!
    }

private var _documentation_20x20: IntellijIconData? = null

private fun Documentation_20x20Composable(colorScheme: IntelliJIconColors): ImageVector =
        Builder(name = "Documentation_20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp,
