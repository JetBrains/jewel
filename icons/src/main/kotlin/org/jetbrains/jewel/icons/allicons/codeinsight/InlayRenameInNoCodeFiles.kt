...
public val CodeinsightGroup.InlayRenameInNoCodeFiles: IntellijIconData
    get() {
        if (_inlayRenameInNoCodeFiles != null) {
            return _inlayRenameInNoCodeFiles!!
        }
        _inlayRenameInNoCodeFiles = IntellijIconData(name = "InlayRenameInNoCodeFiles",size =
                DpSize(height = 12.0.dp, width = 12.0.dp),imageVector = {
                InlayRenameInNoCodeFilesComposable(it) })
        return _inlayRenameInNoCodeFiles!!
    }

private var _inlayRenameInNoCodeFiles: IntellijIconData? = null

private fun InlayRenameInNoCodeFilesComposable(colorScheme: IntelliJIconColors): ImageVector =
        Builder(name = "InlayRenameInNoCodeFiles", defaultWidth = 12.0.dp, defaultHeight = 12.0.dp,
