...
public val ActionsGroup.GroupByPackage: IntellijIconData
    get() {
        if (_groupByPackage != null) {
            return _groupByPackage!!
        }
        _groupByPackage = IntellijIconData(name = "GroupByPackage",size = DpSize(height = 16.0.dp,
                width = 16.0.dp),imageVector = { GroupByPackageComposable(it) })
        return _groupByPackage!!
    }

private var _groupByPackage: IntellijIconData? = null

private fun GroupByPackageComposable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "GroupByPackage", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp, viewportWidth = 16.0f,
