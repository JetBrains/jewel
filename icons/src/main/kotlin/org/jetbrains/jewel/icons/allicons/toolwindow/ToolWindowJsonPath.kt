...
public val ToolwindowGroup.ToolWindowJsonPath: IntellijIconData
    get() {
        if (_toolWindowJsonPath != null) {
            return _toolWindowJsonPath!!
        }
        _toolWindowJsonPath = IntellijIconData(name = "ToolWindowJsonPath",size = DpSize(height =
                16.0.dp, width = 16.0.dp),imageVector = { ToolWindowJsonPathComposable(it) })
        return _toolWindowJsonPath!!
    }

private var _toolWindowJsonPath: IntellijIconData? = null

private fun ToolWindowJsonPathComposable(colorScheme: IntelliJIconColors): ImageVector =
        Builder(name = "ToolWindowJsonPath", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
