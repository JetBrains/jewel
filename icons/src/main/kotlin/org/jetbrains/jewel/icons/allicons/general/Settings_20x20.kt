...
public val GeneralGroup.Settings_20x20: IntellijIconData
    get() {
        if (_settings_20x20 != null) {
            return _settings_20x20!!
        }
        _settings_20x20 = IntellijIconData(name = "Settings_20x20",size = DpSize(height = 20.0.dp,
                width = 20.0.dp),imageVector = { Settings_20x20Composable(it) })
        return _settings_20x20!!
    }

private var _settings_20x20: IntellijIconData? = null

private fun Settings_20x20Composable(colorScheme: IntelliJIconColors): ImageVector = Builder(name =
        "Settings_20x20", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp, viewportWidth = 20.0f,
