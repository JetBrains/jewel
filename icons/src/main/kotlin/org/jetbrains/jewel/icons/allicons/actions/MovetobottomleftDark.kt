...
public val ActionsGroup.MovetobottomleftDark: ImageVector
    get() {
        if (_movetobottomleftDark != null) {
            return _movetobottomleftDark!!
        }
        _movetobottomleftDark = Builder(name = "MovetobottomleftDark", defaultWidth = 16.0.dp,
